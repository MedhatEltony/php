  ...
  <nav style="position: fixed; top:0; bottom:0; Left:0; width:300px; Overflow-x:hidden; overflow-y:scroll; min-height:100%;">
	<div style="text-align:center; display: block; margin-bottom:.809em;">
		...
		<select id="versionSelect" onchange="optionChanged(this.value);" style="margin-bottom:8px;">
			<option value="/OpenDentalDocumentation20-2.xml" hasDiff="true">Version 20.2</option>			<option value="/OpenDentalDocumentation20-3.xml" hasDiff="true">Version 20.3</option>			<option value="/OpenDentalDocumentation20-4.xml" hasDiff="true">Version 20.4</option>			<option value="/OpenDentalDocumentation20-5.xml" hasDiff="true">Version 20.5</option>			<option value="/OpenDentalDocumentation21-1.xml" hasDiff="true">Version 21.1</option>
			<option value="/OpenDentalDocumentation20-1.xml" hasDiff="true">Version 20.1</option>
			<option value="/OpenDentalDocumentation19-4.xml" hasDiff="true">Version 19.4</option>
			<option value="/OpenDentalDocumentation19-3.xml" hasDiff="true">Version 19.3</option>			
			<option value="/OpenDentalDocumentation19-2.xml" hasDiff="true">Version 19.2</option>
			<option value="/OpenDentalDocumentation19-1.xml" hasDiff="true">Version 19.1</option>
			<option value="/OpenDentalDocumentation18-4.xml" hasDiff="true">Version 18.4</option>
			<option value="/OpenDentalDocumentation18-3.xml" hasDiff="true">Version 18.3</option>
